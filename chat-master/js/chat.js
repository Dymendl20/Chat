// Ce code est une adaptation d'un tutoriel de création de
// TODO list en JavaScript qui utilise la fonction
// localStorage pour enregistrer les conversations du chat
// Source : https://code-maven.com/todo-in-html-and-javascript


//Fonction pour récupèrer la conversation (chat) depuis le localStorage
function get_chat() {
    var chat = new Array;
...
//L'argument i détermine quelle fenêtre de chat (user) apelle la fonction
function speak(i) {
    if (i === 1) {
        var user = 'user1';
    } else if (i === 2) {
    ...
    //On prévient d'éventuelles injections de code grâce a la fonction htmlEntities
